...
<head>
    ...
    <base href="<?php echo rtrim(URL_PUBLIC,'/'); ?>/wolf/plugins/ckeditor/scripts/filemanager/" />
...
<body>
    <div>
        ...
        <script type="text/javascript" src="scripts/filemanager_plugins.js"></script>
        <script type="text/javascript">
        // <![CDATA[
<?php echo new View( PLUGINS_ROOT.DS.'ckeditor/views/filter/public/fm_config', array( 'settings' => $settings )); ?>
        // ]]>
        </script>
